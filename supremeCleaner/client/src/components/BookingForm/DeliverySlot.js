...
export default function DeliverySlot() {
  ...
  return (
    <div className="bg-white shadow-lg rounded-md  mx-auto px-8 py-6 my-10 relative">
      <div className="mb-10">
        <h4 className="text-xl pb-2">Please choose a delivery slot</h4>
        <p className="pm text-sm text-secondary ">
          Our driver will come to your chosen address to deliver your clean
          items back.
        </p>
        <p className="pm text-xs text-content ml-5">
          If your order includes leather items, curtains or rugs, please allow 7
          days between the pick up date and the delivery date.
        </p>
      </div>
