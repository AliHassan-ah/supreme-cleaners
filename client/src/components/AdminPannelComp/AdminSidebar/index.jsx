  ...
  return (
    <div className="flex h-screen flex-col px-3 py-4 md:px-2 bg-white">
      ...
      <div className="flex grow flex-col justify-between space-x-2  md:space-x-0">
        <div className="py-[20px] navItems flex flex-row flex-wrap justify-between space-x-2 md:flex-col md:space-x-0 ">
          <NavLinks />
        </div>
        <form>
          <button className="flex h-[48px] grow items-center justify-center gap-2 rounded-md p-3 text-sm font-medium hover:bg-sky-100 hover:text-blue-600 md:flex-none md:justify-start md:p-2 md:px-3">
            ...
            <div className="hidden md:block logOut text-[#B01212]">Log out</div>
          </button>
        </form>
      </div>
    </div>
