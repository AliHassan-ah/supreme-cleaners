...
import BG from "../assets/images/t&cs-header-bg.png";
...
export default function TermAndConditions() {
  const TacContent1 = (
    <p className="text-content text-sm">
      By agreeing to these Terms of Use, you represent that you are at least the
  ...
  const TacContent3 = (
    <p className="text-content text-sm">
      ...
      material on this site is at your own risk. <br />
      <br />
  ...
  const TacContent5 = (
    <p className="text-content text-sm">
      ...
      are subject to return or exchange only according to conditions set forth
      ...
      that your computer monitor's display of any colour will be accurate.{" "}
      <br />
      <br />
      ...
      made on this site is void where prohibited. <br />
      <br />
  ...
  const TacContent6 = (
    <ul className="text-content text-sm md:list-disc faq-list flex flex-col list-outside gap-3">
      <li>
        We make physical and electronic gift cards (“Gift Cards”) and
        promotional coupons or discounts (“Coupons”) available for use on the
        website towards the purchase of goods. Gift Cards and Coupons can only
        be redeemed while they are valid and their expiry dates cannot be
        extended.
      </li>
      <li>
        Gift Cards cannot be used to buy other Gift Cards or Coupons. They do
        not accrue interest and are not refundable for cash. If the value of a
        Gift Card is insufficient for the order you wish to place, you may make
        up the difference by paying via one of our other payment methods.
      </li>
      <li>
        We are not responsible for any harm due to the loss, unauthorised use or
        unauthorised distribution of a Gift Card, after it has been delivered to
        you or the email address nominated by you.
      </li>
      <li>
        Coupons and Gift Cards cannot be exchanged or refunded for cash or
        credit.
      </li>
      <li>
        Coupons are issued at the discretion of The Sneaker Shack and we are
        entitled to correct, cancel or reject a Coupon for any reason and at any
        time (including without limitation where a Coupon has been distributed
        in an unauthorised manner).
      </li>
      <li>
        Coupons are issued under specific Terms and Conditions regulating when
        and how they may be used.
      </li>
      <li>
        If an error is spotted against any coupon or discount on an order, we
        may cancel these order(s) after notifying you.
      </li>
    </ul>
  );
  const TacContent7 = (
  ...
  const TacContent8 = (
    <p className="text-content text-sm">
      ...
      such as food, flowers, newspapers or magazines cannot be returned. We also
      do not accept products that are intimate or sanitary goods, hazardous
      materials, or flammable liquids or gases. <br />
      ...
      to your credit card or original method of payment, within a certain amount
      of days. <br />
      If you haven’t received a refund yet, start by checking your bank account
      again. Then contact your credit card company as it may take some time
      before your refund is officially posted. Next contact your bank. There is
      often some processing time before a refund is posted. If you’ve done all
      of this and you still have not received your refund yet, please contact
      us. <br />
      Only regular priced items may be refunded, unfortunately sale items cannot
      be refunded. You will be responsible for paying for your own shipping
      ...
      product to reach you may vary. If you are shipping an item over R1400.00,
  ...
  const TacContent9 = (
    <p className="text-content text-sm">
      ...
      monitor nor have any control nor input. <br />
      <br />
      ...
      are familiar with and approve of the terms on which tools are provided by
  ...
  const TacContent10 = (
    <p className="text-content text-sm">
      ...
      or for any other materials, products, or services of third-parties. <br />
      <br />
  ...
  const TacContent11 = (
    <p className="text-content text-sm">
      ...
      violates any party’s intellectual property or these Terms of Use. <br />
  ...
  const TacContent12 = (
    <p className="text-content text-sm">
      ...
      our Privacy Policy. <Link to="/privacy">Click </Link> to view our Privacy
      Policy.
    </p>
  );
  const TacContent13 = (
  ...
  const TacContent14 = (
    <p className="text-content text-sm">
      In addition to other prohibitions as set forth in these Terms of Use, you
      ...
      rights of others; (e) to harass, abuse, harm, defame, slander, disparage,
  ...
  const TacContent15 = (
    <p className="text-content text-sm">
      ...
      the service will be accurate or reliable. <br />
      <br />
  ...
  const TacContent16 = (
    <p className="text-content text-sm">
      ...
      Terms of Use or the documents they incorporate by reference, or your
  ...
  const TacContent18 = (
    <p className="text-content text-sm">
      ...
      purposes. These Terms of Use are effective unless and until terminated by
      either you or us. You may terminate these Terms of Use at any time by
      ...
      comply with any term or provision of these Terms of Use, we also may
  ...
  const TacContent19 = (
    <p className="text-content text-sm">
      ...
      limited to, any prior versions of there Terms of Use). <br />
      <br />
  ...
  const TacContent21 = (
    <p className="text-content text-sm">
      You can review the most current version of Terms of Use at any time at
      this page. <br />
      <br /> We reserve the right, at our sole discretion, to update, change or
      replace any part of these Terms of Use by posting updates and changes to
      our website. It is your responsibility to check our website periodically
      for changes. Your continued use of or access to our website or the Service
      following the posting of any changes to these Terms of Use constitutes
            ...
            <div className="md:w-1/2 px-5 md:px-0 md:left-[16%] relative py-12">
              <div>
                <p className=" text-[#101010] text-lg">
                  This website is operated by SUPREME. Throughout the site, the
                  terms “we”, “us” and “our” refer to SUPREME . The SUPREME
                  ...
                  policies and notices stated here. <br />
                  <br />
                  By visiting our site and/or purchasing something from us, you
                  engage in our “Service” and agree to be bound by the following
                  terms and conditions (“Terms of Use”, “Terms”), including
                  those additional terms and conditions and policies referenced
                  herein and/or available by hyperlink. These Terms of Use apply
                  ...
                  Terms of Use are considered an offer, acceptance is expressly
                  limited to these Terms of Use. Any new features or tools which
                  are added to the current store shall also be subject to the
                  Terms of Use. <br />
              ...
              <div className="flex flex-col hs-accordion-group">
                ...
                <SimpleAccordion
                  ...
                  content={TacContent8}
                />
                <SimpleAccordion title="OPTIONAL TOOLS" content={TacContent9} />
                <SimpleAccordion
                  title="THIRD-PARTY LINKS"
                  content={TacContent10}
                />
                <SimpleAccordion
                  title="USER COMMENTS, FEEDBACK, AND OTHER SUBMISSIONS"
                  content={TacContent11}
                />
                <SimpleAccordion
                  title="PERSONAL INFORMATION"
                  content={TacContent12}
                />
                <SimpleAccordion
                  title="ERRORS, INACCURACIES, AND OMISSIONS"
                  content={TacContent13}
                />
                <SimpleAccordion
                  title="PROHIBITED USES"
                  content={TacContent14}
                />
                <SimpleAccordion
                  title="DISCLAIMER OF WARRANTIES AND LIMITATION OF LIABILITY"
                  content={TacContent15}
                />

                <SimpleAccordion
                  title=" INDEMNIFICATION"
                  content={TacContent16}
                />
                <SimpleAccordion title="SEVERABILITY" content={TacContent17} />
                <SimpleAccordion title="TERMINATION" content={TacContent18} />
                <SimpleAccordion
                  title="ENTIRE AGREEMENT"
                  content={TacContent19}
                />
                <SimpleAccordion title="GOVERNING LAW" content={TacContent20} />
                <SimpleAccordion
                  title="CHANGES TO TERMS OF USE"
                  content={TacContent21}
                />
              </div>
            </div>
          </div>
